...
def a():
	...
	if a == "":
		...
		if Alarmtime == CurrentTime:
			mixer.music.load('C:\\Users\\Asus2\\OneDrive\\Desktop\\python\\debotices\\tone.mp3')
			mixer.music.play()
...
alpp = PhotoImage(file="C:\\Users\\Asus2\\OneDrive\\Desktop\\python\\debotices\\al1.png" ,width=20, height=20)
